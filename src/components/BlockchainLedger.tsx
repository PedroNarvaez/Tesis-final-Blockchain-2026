      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 space-y-4">
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 space-y-4">
            ...
            {/* Blocks Cards Layout */}
            <div className="space-y-3 max-h-[500px] overflow-y-auto pr-2" role="listbox" aria-label="Secuencia de Bloques Confirmados">
              {blocks.map((block) => {
                ...
                return (
                  <div
                    ...
                    className={`p-4 rounded-lg border hover:border-slate-600 transition-all cursor-pointer flex items-center justify-between gap-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-blue-500 ${
                      isSelected
