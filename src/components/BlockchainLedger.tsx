              ...
              {blocks.map((block) => {
                ...
                return (
                  <button
                    ...
                    aria-label={`Bloque número ${block.indice}, confirmado por ${block.validador}, resumen: ${block.evidencias.datosResumen}`}
                    className={`p-4 rounded-lg border hover:border-slate-600 transition-all cursor-pointer flex items-center justify-between gap-4 w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
                      isSelected
