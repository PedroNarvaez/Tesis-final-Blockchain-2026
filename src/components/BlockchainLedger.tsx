              ...
              {blocks.map((block) => {
                ...
                return (
                  <div
                    ...
                    aria-label={`Ver detalles del bloque número ${block.indice}`}
                    className={`p-4 rounded-lg border hover:border-slate-600 transition-all cursor-pointer flex items-center justify-between gap-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
                      isSelected
