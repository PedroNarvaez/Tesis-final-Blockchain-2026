      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
        ...
        <div className="xl:col-span-1 bg-slate-900 border border-slate-800 p-5 rounded-xl space-y-6 h-fit">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="toleranciaMonetaria" className="text-xs font-semibold text-slate-400 block mb-1 cursor-pointer">
                Tolerancia Monetaria (Gs.)
              </label>
              <input
                id="toleranciaMonetaria"
                type="number"
                value={localRules.toleranciaMonetaria}
                onChange={(e) => handleRuleChange('toleranciaMonetaria', parseInt(e.target.value) || 0)}
                className="w-full bg-slate-950 border border-slate-800 focus:border-blue-500 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none rounded-lg px-3 py-2 text-sm text-white"
                min="0"
              />
            ...
            <div>
              <label htmlFor="ventanaFechasDias" className="text-xs font-semibold text-slate-400 block mb-1 cursor-pointer">
                Ventana de Fechas (Días)
              </label>
              <input
                id="ventanaFechasDias"
                type="number"
            ...
            <div>
              <label htmlFor="scoreAutoaprobacion" className="text-xs font-semibold text-slate-400 block mb-1 cursor-pointer">
                Score de Autoaprobación (%)
              </label>
              <div className="flex items-center gap-3">
                <input
                  id="scoreAutoaprobacion"
                  type="range"
                  min="50"
                  max="100"
                  value={localRules.scoreAutoaprobacion}
                  onChange={(e) => handleRuleChange('scoreAutoaprobacion', parseInt(e.target.value))}
                  className="flex-1 accent-blue-500 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none rounded"
                />
            ...
            {/* Toggle 4: Exigir RUC */}
            <div className="py-2 border-t border-b border-slate-800/60">
              <label htmlFor="exigirRuc" className="flex items-center justify-between cursor-pointer select-none">
                <div>
                ...
                <input
                  ...
                  className="h-4 w-4 accent-blue-500 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none rounded cursor-pointer"
                />
              </label>
            </div>
            ...
            <div className="py-2">
              <label htmlFor="exigirMismaCuenta" className="flex items-center justify-between cursor-pointer select-none">
                <div>
