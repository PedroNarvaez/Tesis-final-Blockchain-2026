              ...
              {filteredExceptions.length === 0 ? (
                ...
                filteredExceptions.map(exc => (
                  <button
                    ...
                    aria-label={`Caso ${exc.id}: ${exc.motivo}. Prioridad: ${exc.prioridad}. Estado: ${exc.estado}. Exposición Financiera: Gs. ${exc.exposicion.toLocaleString()}. Confianza: ${exc.confianza}%.`}
                  >
                    <div className="space-y-1.5">
                      ...
                      <span className="text-sm font-semibold text-white block">{exc.motivo}</span>
