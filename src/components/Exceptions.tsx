      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-5">
        ...
        <div className="flex gap-2 bg-slate-950 p-1 border border-slate-800 rounded-lg">
          <button
            ...
            aria-label={`Mostrar todas las excepciones, actual ${exceptions.length}`}
          >
          ...
          <button
            ...
            aria-label={`Mostrar excepciones pendientes, actual ${exceptions.filter(e => e.estado === 'pendiente').length}`}
          >
          ...
          <button
            ...
            aria-label={`Mostrar excepciones procesadas, actual ${exceptions.filter(e => e.estado !== 'pendiente').length}`}
          >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 space-y-4">
          <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
            ...
            <div className="divide-y divide-slate-800/60" role="list" aria-label="Lista de casos abiertos de riesgo">
              {filteredExceptions.length === 0 ? (
                ...
                filteredExceptions.map(exc => (
                  <div
                    ...
                    className={`p-4 hover:bg-slate-950/20 cursor-pointer transition-all flex flex-col md:flex-row md:items-center justify-between gap-4 outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${selectedCase?.id === exc.id ? 'bg-blue-600/5 border-l-4 border-l-blue-500 pl-3' : 'pl-4'}`}
                  >
                ...
                {selectedCase.estado === 'pendiente' ? (
                  <div className="space-y-2 pt-2">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-3 py-2 text-xs font-bold bg-slate-800 hover:bg-slate-700 text-white rounded-lg transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-500"
                    >
