      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-5">
        ...
        <div className="flex flex-wrap items-center gap-2 bg-slate-950 p-1.5 border border-slate-800 rounded-lg">
          ...
          <button
            ...
            className={`px-3 py-1 text-xs font-semibold rounded-md border transition-all focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none ${getScenarioClass('diario')}`}
          >
            Operación Diaria
          </button>
          <button
            onClick={() => setScenario('mensual')}
            className={`px-3 py-1 text-xs font-semibold rounded-md border transition-all focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none ${getScenarioClass('mensual')}`}
          >
            Cierre Mensual
          </button>
          <button
            onClick={() => setScenario('fraude')}
            className={`px-3 py-1 text-xs font-semibold rounded-md border transition-all focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none ${getScenarioClass('fraude')}`}
          >
